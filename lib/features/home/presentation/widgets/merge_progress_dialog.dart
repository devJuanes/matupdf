...
class MergeProgressDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final maxWidth = Responsive.value(
      context: context,
      mobile: MediaQuery.sizeOf(context).width - 40,
      desktop: 420.0,
    );
      ...
      child: ConstrainedBox(
        ...
        child: Container(
          ...
          padding: EdgeInsets.symmetric(
            horizontal: Responsive.value(context: context, mobile: 24, desktop: 36),
            vertical: Responsive.value(context: context, mobile: 28, desktop: 40),
          ),
          ...
          child: Column(
            ...
            children: [
              ...
              if (isComplete) ...[
                ...
                const VoluntaryTipLink(compact: true),
              ],
            ],
          ),
        ),
